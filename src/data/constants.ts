...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Grupo Águas do Brasil",
    description: [
      "Support for the sector's administrative routines, contributing to the organization and standardization of internal documents.",
      "Control and updating of spreadsheets to monitor team activities and deadlines.",
      "Organization of physical and digital files, facilitating the location of information and reducing rework.",
      "Support in monitoring daily demands, ensuring compliance with established goals and deadlines.",
    ],
    skills: [
    ],
  }
